...
<div class="space-y-5">
    ...
    <div class="content-card overflow-hidden">
        <div class="px-6 py-4 flex items-center gap-2" style="border-bottom:1px solid #E2E8F0;">
            ...
            <h2 class="font-bold" style="color:#1E293B;">Tambah Data Alternatif</h2>
        </div>
            ...
            <div class="px-6 py-6 space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="kode_alternatif" value="{{ old('kode_alternatif') }}" class="form-input @error('kode_alternatif') border-red-500 @enderror" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_alternatif" value="{{ old('nama_alternatif') }}" class="form-input @error('nama_alternatif') border-red-500 @enderror" required>
