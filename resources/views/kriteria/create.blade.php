...
<div class="space-y-5">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="page-subtitle">Tambah data kriteria baru</p>
        </div>
    ...
    <div class="content-card overflow-hidden">
        <div class="px-6 py-4 flex items-center gap-2" style="border-bottom:1px solid rgba(33,230,193,0.1);">
            ...
            <h2 class="font-bold" style="color:rgba(255,255,255,0.8);">Tambah Data Kriteria</h2>
        </div>
            ...
            <div class="px-6 py-6 space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="kode" value="{{ old('kode') }}" class="form-input @error('kode') border-red-500 @enderror" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="bobot" value="{{ old('bobot') }}" step="0.01" min="0" max="100" class="form-input @error('bobot') border-red-500 @enderror" required>
