                ...
                <table class="tbl text-center">
                    ...
                    <tbody>
                        ...
                        <tr style="background:rgba(33,230,193,0.06);">
                            ...
                            <?php $__currentLoopData = $kriterias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><td class="font-bold" style="color:#278EA5;"><?php echo e($matriksKeputusan['total'][$k->id_kriteria]); ?></td><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="px-6 py-4" style="overflow-x:auto;">
                <table class="tbl text-center">
                    ...
                    <tbody>
                        ...
                        <tr style="background:rgba(33,230,193,0.06);">
                            <td colspan="2" class="font-bold" style="color:#278EA5;">Total</td>
                            <td class="font-bold" style="color:#278EA5;"><?php echo e($sMinusData['total']); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="px-6 py-4" style="overflow-x:auto;">
                <table class="tbl text-center">
                    ...
                    <tbody>
                        ...
                        <tr style="background:rgba(33,230,193,0.06);">
                            <td colspan="2" class="font-bold" style="color:#278EA5;">Total</td>
                            <td class="font-bold" style="color:#278EA5;"><?php echo e($relativeWeightData['sumInverse']); ?></td>
                            <td></td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="content-card overflow-hidden">
            ...
            <div class="px-6 py-4 space-y-4" style="overflow-x:auto;">
                ...
                <div class="flex items-center gap-3 px-5 py-3 rounded-xl" style="background:rgba(33,230,193,0.08); border:1px solid rgba(33,230,193,0.2);">
                    ...
                    <p class="text-sm font-bold" style="color:#278EA5;">Nilai Max Qi = <?php echo e($utilityDegreeData['maxQ']); ?></p>
                </div>
            </div>
        </div>
                ...
                <table class="tbl text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($i + 1); ?></td>
                            <td style="text-align:left;"><?php echo e($row['nama_alternatif']); ?></td>
                            <td class="font-bold" style="color:#278EA5;"><?php echo e($row['nilai_u']); ?>%</td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
